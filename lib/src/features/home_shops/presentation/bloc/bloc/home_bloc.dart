...
class HomeBloc extends Bloc<HomeEvent, HomeBlocState> {
  ...
  HomeBloc(this.getLocationUsecase, this.getCategoriesUsecase, this.getAdBannersUsecase, this.getShopsUsecase ) : super(_Initial()) {
  ...
  Future<void> _getCategories(HomeEvent event, Emitter<HomeBlocState> emit,) async {
  ...
  Future<void> _getBanners(HomeEvent event, Emitter<HomeBlocState> emit, String locationId) async {
  ...
  Future<void> _getShops(HomeEvent event, Emitter<HomeBlocState> emit, String locationId) async {
    emit(_LoadingShops());
